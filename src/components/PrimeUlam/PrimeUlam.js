...
import { secondaryColorLight } from '../App/App'
    ...
    doms.push((
      <div
        ...
        id={field.name}>
          ...
          <TSlider
            handleStyle={{backgroundColor: secondaryColorLight, borderColor: secondaryColorLight}}
            trackStyle={{backgroundColor: secondaryColorLight, borderColor: secondaryColorLight}}
